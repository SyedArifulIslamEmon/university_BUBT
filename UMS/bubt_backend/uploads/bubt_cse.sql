...
INSERT INTO `book` (`book_id`, `name`, `author`, `status`) VALUES
(1, 'Data Mining - Concepts and Techniques (3rd Ed)', 'Jiawei Han, Micheline Kamber. Jian Pei', 'available'),
(2, 'neural network', 'simon haykin', 'available'),
(3, 'Fundamentals of electric circuits 4th edition', 'alexander sadiku', 'available'),
(4, 'system analysis and design', 'Elias M. awad', 'unavailable'),
(6, 'accounting fundamentals', 'kaiso', 'available'),
(7, 'computer fundamentals', 'norton', 'available'),
(8, 'vlsi design', 'lynda', 'unavailable'),
(9, 'computer peripherals and interfacing', 'berry m. cook', 'available');
...
CREATE TABLE IF NOT EXISTS `class` (
  ...
  `name` longtext COLLATE utf8_unicode_ci NOT NULL,
  `name_numeric` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `teacher_id` int(11) NOT NULL,
  PRIMARY KEY (`class_id`),
  UNIQUE KEY `name_numeric` (`name_numeric`)
...
(1, 'intake-17(1)', '17(1)', 1),
(2, 'intake-18(1)', '18(1)', 1),
(3, 'intake-19(1)', '19(1)', 1),
(4, 'intake-20(1)', '20(1)', 1),
(5, 'intake-20(2)', '20(2)', 1),
(6, 'intake-21(1)', '21(1)', 1),
(7, 'intake-22(1)', '22(1)', 1),
(8, 'intake-22(2)', '22(2)', 2),
(9, 'intake-23(1)', '23(1)', 0),
(10, 'intake-23(2)', '23(2)', 0),
(11, 'intake-24(1)', '24(1)', 0),
(12, 'intake-24(2)', '24(2)', 0);
...
INSERT INTO `class_routine` (`class_routine_id`, `class_id`, `subject_id`, `teacher_id`, `room_id`, `time_start`, `time_end`, `day`) VALUES
(1, 1, 6, 1, 1, '8.30', '9.30', 'monday'),
(4, 2, 2, 0, 0, '00:00:16', '00:00:17', 'thursday'),
(5, 1, 1, 2, 3, '9.35', '10.35', 'tuesday'),
(6, 5, 5, 0, 0, '00:00:00', '00:00:00', 'thursday'),
(8, 1, 1, 2, 1, '9.35', '10.35', 'sunday'),
(14, 12, 4, 6, 2, '9', '10', 'sunday'),
(15, 12, 5, 8, 4, '10', '11', 'wednesday'),
(17, 1, 1, 3, 1, '3.25', '4.25', 'thursday'),
(18, 4, 5, 0, 0, '1.15', '2.15', 'tuesday'),
(20, 3, 4, 0, 0, '9.35', '11.40', 'tuesday'),
(21, 8, 5, 0, 0, '10.40', '11.40', 'tuesday'),
(22, 9, 1, 0, 0, '1.15', '2.15', 'friday'),
(23, 1, 9, 1, 1, '10.40', '11.40', 'monday'),
(24, 1, 2, 3, 1, '10.40', '11.40', 'sunday');
...
(1, 'fall 2014-15', '02/04/2015', 'final'),
(4, 'spring-2015', '05/26/2015', 'Final');
...
(4, 5, 'fall-14-15', 'registration', 6000, 1424905200, '', '', '', 'paid'),
(5, 6, 'fall-14-15', 'registration', 6000, 1424905200, '', '', '', 'paid'),
(8, 3, 'fall-14-15', 'registration', 6000, 1424905200, '', '', '', 'paid'),
(7, 7, 'fall-14-15', 'registration', 6000, 1424905200, '', '', '', 'unpaid'),
(9, 9, 'fall-14-15', 'registration', 6000, 1425942000, '', '', '', 'paid'),
(10, 13, 'fall-14-15', 'registration', 6000, 1425250800, '', '', '', 'paid'),
(11, 10, 'fall-14-15', 'registration', 6000, 1425250800, '', '', '', 'paid');
...
CREATE TABLE IF NOT EXISTS `it_officer` (
  `it_officer_id` int(111) NOT NULL AUTO_INCREMENT,
  `name` longtext COLLATE utf8_unicode_ci NOT NULL,
  `phone` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`it_officer_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=3 ;

--
-- Dumping data for table `it_officer`
--

INSERT INTO `it_officer` (`it_officer_id`, `name`, `phone`, `status`) VALUES
(1, 'Rayhanul kabir', '26566626262', 'unavailable'),
(2, 'sikandar ali khan', '51521485156651', 'available');
...
(226, 'daily_attendance', 'Daily Attendance', 'দৈনিক উপস্থিতি', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(225, 'Stuff', 'Stuff', 'স্টাফ', 'cosas', 'أشياء', 'spul', 'вещи', '东东', 'şey', 'material', 'dolog', 'étoffe', 'υλικό', 'Zeug', 'roba', 'สอดไส้', 'چیزیں', 'सामग्री', 'Stuff', 'barang', 'スタッフ', '물건'),
(227, 'stuff_name', 'Stuff Name', 'স্টাফ নাম', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(228, 'total_students', 'Total students', 'মোট ছাত্র-ছাত্রী', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(229, 'room', 'room', 'কক্ষ', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(230, 'admit student', 'admit student', 'ছাত্র ভর্তি', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
(1, 1, 1, 1, 1, 72, 100, 3, 'A-'),
(2, 5, 1, 1, 1, 75, 100, 4, ''),
(3, 6, 1, 1, 1, 0, 100, 0, ''),
(4, 7, 1, 1, 1, 84, 100, 4, ''),
(5, 8, 1, 1, 1, 99, 100, 5, '0'),
(6, 9, 1, 1, 1, 0, 100, 0, ''),
(7, 10, 1, 1, 1, 0, 100, 0, ''),
(8, 11, 1, 1, 1, 0, 100, 0, ''),
(9, 12, 1, 1, 1, 0, 100, 0, ''),
(10, 13, 1, 1, 1, 72, 100, 3, '0'),
(11, 5, 2, 1, 1, 86, 100, 5, '0'),
(12, 6, 2, 1, 1, 45, 100, 2, '0'),
(13, 7, 2, 1, 1, 66, 100, 4, '0'),
(14, 8, 2, 1, 1, 99, 100, 3, '0'),
(15, 9, 2, 1, 1, 88, 100, 5, '0'),
(16, 10, 2, 1, 1, 40, 100, 1, '0'),
(17, 11, 2, 1, 1, 22, 100, 4, '0'),
(18, 12, 2, 1, 1, 70, 100, 5, '0'),
(19, 13, 2, 1, 1, 80, 100, 5, 'A+'),
(20, 3, 4, 2, 3, 0, 100, 0, ''),
(21, 14, 1, 1, 1, 0, 100, 0, ''),
(22, 5, 6, 1, 1, 0, 100, 0, ''),
(23, 6, 6, 1, 1, 0, 100, 0, ''),
(24, 7, 6, 1, 1, 0, 100, 0, ''),
(25, 8, 6, 1, 1, 99, 100, 5, '0'),
(26, 9, 6, 1, 1, 0, 100, 0, ''),
(27, 10, 6, 1, 1, 0, 100, 0, ''),
(28, 11, 6, 1, 1, 0, 100, 0, ''),
(29, 12, 6, 1, 1, 0, 100, 0, ''),
(30, 13, 6, 1, 1, 72, 100, 3, '0'),
(31, 14, 6, 1, 1, 0, 100, 0, ''),
(32, 5, 7, 1, 1, 0, 100, 0, ''),
(33, 6, 7, 1, 1, 0, 100, 0, ''),
(34, 7, 7, 1, 1, 0, 100, 0, ''),
(35, 8, 7, 1, 1, 100, 100, 5, '0'),
(36, 9, 7, 1, 1, 0, 100, 0, ''),
(37, 10, 7, 1, 1, 0, 100, 0, ''),
(38, 11, 7, 1, 1, 0, 100, 0, ''),
(39, 12, 7, 1, 1, 0, 100, 0, ''),
(40, 13, 7, 1, 1, 86, 100, 5, '0'),
(41, 14, 7, 1, 1, 0, 100, 0, ''),
(42, 3, 9, 2, 3, 76, 100, 4, '0'),
(43, 3, 3, 2, 1, 70, 100, 4, '0'),
(44, 3, 4, 2, 1, 70, 100, 4, '0'),
(45, 3, 8, 2, 1, 65, 100, 3, '0'),
(46, 3, 9, 2, 1, 65, 100, 5, '0'),
(47, 14, 2, 1, 1, 77, 100, 5, '0'),
(48, 5, 1, 1, 3, 0, 100, 0, ''),
(49, 6, 1, 1, 3, 0, 100, 0, ''),
(50, 7, 1, 1, 3, 0, 100, 0, ''),
(51, 8, 1, 1, 3, 0, 100, 0, ''),
...
(1, 'ct', 'ct', 1426028400),
(2, 'ct schedule has been postponed', 'ct schedule has been postponed', 1426028400),
(3, 'Pohela Boishakh', 'Cultural Program', 1428962400);
...
(7, 'syed anwarul islam', 'saislam@gmail.com', '1234', 13, 'father', '+8801675641515szdsa', 'dhanmondi,dhaka', 'professor'),
(8, 'fsdafsdaf', 'asasff@gmail.com', '1234', 5, 'mother', '5215216321', 'dsfsdfas', 'housewife'),
(9, 'rdhbdfgs', 'sdgsdag@gmail.com', '1234', 6, 'father', '554546545', 'njksdnkskm', 'ksdkkasn'),
(10, 'sdfsdf', 'sdfszxcxz@gmail.com', '1234', 7, 'father', '14252456', 'sdfsCF', 'safascf');
...
INSERT INTO `room` (`room_id`, `room_no`, `room_type`) VALUES
(1, 'R-301', 'Theory'),
(2, 'R-302', 'Theory'),
(3, 'R-303', 'Lab'),
(4, 'R-304', 'Lab'),
(5, 'R-305', 'Chairman Room');
...
CREATE TABLE IF NOT EXISTS `scale` (
  ...
  `scale_from` int(11) NOT NULL,
  `scale_upto` int(11) NOT NULL,
...
INSERT INTO `scale` (`scale_id`, `scale_from`, `scale_upto`, `scale`) VALUES
(1, 90, 100, 5),
(2, 80, 89, 4),
(3, 70, 79, 3),
(4, 60, 69, 2),
...
(1, 'system_name', 'BUBT'),
(2, 'system_title', 'BUBT'),
(3, 'address', 'Mirpur-2,Dhaka, Bangladesh'),
(4, 'phone', '+8012654159'),
(5, 'paypal_email', 'payment@bubt.com'),
(6, 'currency', 'bdt'),
(7, 'system_email', 'cse@bubt.com'),
(8, 'buyer', 'bubt.com'),
(9, 'purchase_code', '0'),
(11, 'language', 'english'),
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  UNIQUE KEY `email` (`email`,`class_id`)
...
INSERT INTO `student` (`student_id`, `name`, `birthday`, `sex`, `religion`, `blood_group`, `address`, `phone`, `email`, `password`, `father_name`, `mother_name`, `class_id`, `roll`) VALUES
(3, 'naim ahmed', '05/08/1990', 'male', '', '', 'commerce college', '+880171456987', 'naim@gmail.com', '1234', 'zxc', 'vbn', 2, '0'),
(5, 'Mobasshira  Firuze', '05/05/1992', 'female', '', 'A-', 'sdszXCXx', '2316556415151', 'firuze@gmail.com', '0', 'bjbjmnbjbj', 'nmnjjbjb', 1, '10112103002'),
(6, 'Ashraf -E- Naznin', '03/06/1991', 'female', '', 'A+', 'safcsa', 'zzxcz', 'naznin@gmail.com', '0', 'sadffsad', 'sdfdsfv', 1, '10112103003'),
(7, 'Md. Mostafijur Rahman', '03/01/1992', 'male', '', 'A+', 'mirpur', '25151515151522', 'mostaf@gmail.com', '1234', 'fdhdgsdgsd', 'sdfgvdsfvxzdvsde', 1, '10112103004'),
(8, 'Jayeed Bin Abdul Quddus', '12/06/1992', 'male', '', 'A+', 'Mirpur-2,Dhaka, Bangladesh', '+8801674057529', 'jayeed@gmail.com', '1234', 'Abdul Quddus', 'Sajeda Begom', 1, '10112103005'),
(9, 'Mst. Habiba Sultana', '', 'female', '', '', '', '', 'habiba@gmail.com', '1234', '', '', 1, '10112103006'),
(10, 'A.B.M. Mahamudul Hasan', '', 'male', '', '', '', '', 'mahmud@gmail.com', '1234', '', '', 1, '10112103009'),
(11, 'Shahara Binta Alam', '', 'female', '', '', '', '', 'shahara@gmail.com', '1234', '', '', 1, '10112103010'),
(12, 'Ala  Uddin', '', 'male', '', '', '', '', 'alauddin@gmail.com', '1234', '', '', 1, '10112103011'),
(13, 'Syed Ariful Islam Emon', '10/20/1993', 'male', '', 'O+', '27,circular road,dhanmondi', '+8801674057529', 'emon.tarzan@gmail.com', '0', 'syed anwarul islam', 'kohinoor begum', 1, '10112103012'),
(14, 'nazmus sakib', '03/02/1992', 'male', '', 'O+', 'mirpur', '2152654552', 'sakib@gmail.com', '', 'sdjhjas', 'dsnsdnfsan', 1, '10112103013');
...
INSERT INTO `stuff` (`stuff_id`, `name`, `phone`, `status`) VALUES
(1, 'md.shohag', '52151511132', 'available'),
(2, 'md.shamim', '545121', 'unavailable'),
(3, 'ekram hossain', '444546665', 'available'),
(4, 'jahir rayhan', '4154252121', 'available');
...
INSERT INTO `subject` (`subject_id`, `name`, `course_no`, `class_id`, `teacher_id`) VALUES
(10, 'DLD', 'CSE-205', 1, 7),
(11, 'DLD Lab', 'CSE-206', 1, 7),
(4, 'operating system', 'CSE-217', 2, 7),
(9, 'operating system lab', 'CSE-218', 2, 7),
(5, 'system analysis and design', 'CSE-331', 4, 4),
(2, 'neural network', 'CSE-339', 1, 3),
(7, 'neural network lab', 'CSE-340', 1, 3),
(1, 'data mining', 'CSE-439', 1, 2);
...
CREATE TABLE IF NOT EXISTS `teacher` (
  ...
  UNIQUE KEY `teacher_code_2` (`teacher_code`,`email`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10 ;
...
INSERT INTO `teacher` (`teacher_id`, `name`, `teacher_code`, `designation`, `birthday`, `blood_group`, `email`, `phone`, `address`, `password`) VALUES
(1, 'Md. Raisul Allam', 'MRA', 'associate_professor', '12/08/1980', '0', 'ralam.cse@bubt.com', '2515151521', 'Mirpur-2,Dhaka, Bangladesh', '1234'),
(2, 'samsuddin ahmed', 'SUA', 'associate_professor', '05/10/1983', '0', 'sua.cse@bubt.com', '2510206551', 'Mirpur-2,Dhaka, Bangladesh', '1234'),
(3, 'Kashfia Sailunaz', 'KS', 'assistant_professor', '04/03/1987', '0', 'ks.cse@bubt.com', '21154151', 'dsfsdfas', '1234'),
(4, 'md.saifur rahman', 'SFR', 'professor', '01/01/1980', '0', 'saifur@gmail.com', '56151451521', 'sfcac', '1234'),
(5, 'sabiha firdaus', 'SF', 'associate_professor', '04/04/1980', '0', 'sabiha@bubt.com', '2515151', 'Mirpur-2,Dhaka, Bangladesh', '1234'),
(6, 'shoeb ahmed', 'SAS', 'assistant_professor', '04/04/2015', '0', 'shoeb@bubt.com', '3221515641', 'Mirpur-2,Dhaka, Bangladesh', '1234'),
(7, 'Md. mahbubur rahman', 'MMR', 'assistant_professor', '04/04/2015', '0', 'mahbub@bubt.com', '3252151', 'Mirpur-2,Dhaka, Bangladesh', '1234'),
(8, 'Md shahiduz zaman', 'MSZ', 'lecturer', '04/04/2015', '0', 'shahid@bubt.com', '32263125121521', 'Mirpur-2,Dhaka, Bangladesh', '1234'),
(9, 'md atikur rahman', 'ATK', 'lecturer', '05/10/1985', '0', 'atik@bubt.com', '3156151251', 'Mirpur-2,Dhaka, Bangladesh', '1234');
